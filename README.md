...
<p align="center">
<a href="#"><img alt="MH-DDoS forks" src="https://img.shields.io/github/forks/mengheangkh/MHDDOS?style=for-the-badge"></a>
<a href="#"><img alt="MH-DDoS last commit (main)" src="https://img.shields.io/github/last-commit/mengheangkh/MHDDOS/main?color=green&style=for-the-badge"></a>
<a href="#"><img alt="MH-DDoS Repo stars" src="https://img.shields.io/github/stars/mengheangkh/MHDDOS?style=for-the-badge&color=yellow"></a>
<a href="#"><img alt="MH-DDoS License" src="https://img.shields.io/github/license/mengheangkh/MHDDOS?color=orange&style=for-the-badge"></a>
<a href="https://github.com/MatrixTM/MHDDoS/issues"><img alt="MatrixTM issues" src="https://img.shields.io/github/issues/mengheangkh/MHDDOS?color=purple&style=for-the-badge"></a>
...
You can read it from [GitHub Wiki](https://github.com/mengheangkh/MHDDOS/wiki)

**Clone and Install Script**

```shell script
git clone https://github.com/mengheangkh/MHDDOS
cd MHDDoS
...
```shell script
apt -y update && apt -y install curl wget libcurl4 libssl-dev python3 python3-pip make cmake automake autoconf m4 build-essential git && git clone https://github.com/mengheangkh/MHDDOS.git && cd MH* && pip3 install -r requirements.txt
```

**Docker**

```shell script
git clone https://github.com/mengheangkh/MHDDOS.git
cd MHDDOOS
...
[github issues]: https://github.com/mengheangkh/MHDDOS/issues 'enter'
